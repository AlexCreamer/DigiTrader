...
def register_page(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            datas['email_path']="/home/onix/Digital_Credit_Ledger/Users/ActivationEmail.txt"
...
def reset_password(request): #send email with new password set new password, check if email exists 
    ...
    if request.method == 'POST' and form.is_valid():
        ...
        u.save()
        send_mail('new password', 'hello, please log with this password and change it http://localhost.com/change_password/:' + password , 'creamerprojects@gmail.com', [form.cleaned_data['email']], fail_silently=False)
        success = True
